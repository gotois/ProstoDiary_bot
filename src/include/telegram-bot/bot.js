  ...
  try {
    ...
    switch (type) {
      case 'text': {
        ...
        await require('./controllers/text.event')(message);
        break;
      }
      case 'photo': {
      ...
      case 'group_chat_created': {
        await require('./controllers/group-chat-created.event')(message);
        break;
      }
      case 'new_chat_members': {
        await require('./controllers/new-chat-members.event')(message);
        break;
      }
...
// todo: функционал sendMessage, sendChatAction, editMessageText перенести в lib/telegramBot.js
